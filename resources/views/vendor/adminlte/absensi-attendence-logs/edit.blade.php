...
@section('content')
    <div class="card col-md-12">
        <div class="card-header">
            <h2 class="card-title fw-bold fs-4">Edit Presensi</h2>
            <div class="card-tools">
                @can('admin.absensi_attendence_log.index')
                    <a class="btn btn-sm btn-primary" href="{{ route('admin.absensi_attendence_log.index') }}">
        ...
        <div class="card-body">
            @include('vendor.adminlte.absensi-device-users.form-edit',['absensi_users'])
        </div>
    </div>
