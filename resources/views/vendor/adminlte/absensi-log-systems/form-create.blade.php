...
<form action="{{ route('admin.absensi_attendence_log.store') }}" class="form-create-absensi_user" method="POST" enctype="multipart/form-data">
    @csrf
...
<script>
	...
	$(document).ready(function(){
		...
		$("body").on("submit",".form-create-absensi_user",function(e){
			...
			var id = $(this).data("id");
			var url = "{{ route('admin.absensi_attendence_log.store')}}";
