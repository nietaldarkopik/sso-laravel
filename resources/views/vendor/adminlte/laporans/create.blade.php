...
@section('content')
    <div class="card col-md-12">
        <div class="card-header">
            <h2 class="card-title fw-bold fs-4">Buat Laporan</h2>
        ...
        <div class="card-body ajax-container">
            ...
            @include('vendor.adminlte.laporans.form-create')
        </div>
    </div>
...
<script>
	$(document).ready(function(){
		...
		$('.dropzone-document').dropzone({
			url: '{{ route('admin.laporan.uploadDokumen',['pengajuan' => 'xxx']) }}',
			maxFilesize: 512, // MB
			dataType: "json",
			addRemoveLinks: true,
		...
		$("body").on("submit",".form-create-pengajuan",function(e){
			...
			var kode = $(this).val();
			var id = $(this).data("id");
			var url = "{{ route('admin.laporan.store')}}";
