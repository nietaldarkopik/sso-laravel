...
@section('content_header')
    <h1 class="m-0 text-dark">Data Presensi Karyawan</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-header">
            <h2 class="card-title fw-bold fs-4">Data Presensi Karyawan</h2>
    ...
    <script>
        ...
        $('#search').on('click', function(e) {
            ...
            window.LaravelDataTables["absensi-users-table"].table()
                                                            .ajax
                                                            .url('{{ route('admin.absensi_attendence.index') }}?jenis='+jenis+'&id_device='+id_device+'&id_user='+id_user+'&start_date='+start_date+'&start_date=' + start_date + '&end_date=' + end_date)
                                                            .load();
