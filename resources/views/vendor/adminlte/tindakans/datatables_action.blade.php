...
<form action="{{ route('admin.pengajuan.destroy', $id) }}" method="post">
    ...
    <div class="btn-group mt-1" role="group" aria-label="Basic checkbox toggle button group">
        ...
        <a href="{{ route('admin.tindakan.stepDetail', $id) }}" role="button" class="btn btn-primary btn-sm" data-tooltip="tooltip" data-toggle="modal" data-target="#modalLgId" data-backdrop="static" data-keyboard="false" data-modal-title="Tracking Pengajuan" data-title="Lihat Tracking Pengajuan" title="Lihat Tracking Pengajuan">
