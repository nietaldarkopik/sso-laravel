...
@section('content')
    <div class="card col-md-12">
        <div class="card-header">
            <h2 class="card-title fw-bold fs-4">Edit Pengajuan</h2>
        ...
        <div class="card-body">
            @include('vendor.adminlte.pengajuans.form-edit',['pengajuans'])
        </div>
    </div>
...
<script>
	$(document).ready(function(){
		...
		$('.dropzone-document').dropzone({
			url: '{{ route('admin.pengajuan.uploadDokumen',['pengajuan' => $pengajuan->id]) }}',
			maxFilesize: 512, // MB
			dataType: "json",
			addRemoveLinks: true,
		...
		$("body").on("submit",".form-create-pengajuan",function(e){
			...
			var kode = $(this).val();
			var id = $(this).data("id");
			var url = "{{ route('admin.pengajuan.update',['pengajuan' => $pengajuan->id])}}";
