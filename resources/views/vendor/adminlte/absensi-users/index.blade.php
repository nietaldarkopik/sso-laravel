...
@section('content')
    <div class="card">
        <div class="card-header">
            <h2 class="card-title fw-bold fs-4">Data Karyawan</h2>
            <div class="card-tools">
                @can('admin.absensi_user.create')
                    <a class="btn btn-sm btn-primary" href="{{ route('admin.absensi_user.create') }}" data-toggle="modal" data-target="#modalLgId" data-modal-title="Tambah Data">
