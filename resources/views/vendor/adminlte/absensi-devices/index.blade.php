...
@section('content_header')
    <h1 class="m-0 text-dark">Data Device</h1>
@stop

@section('content')
    <div class="card">
        <div class="card-header">
            <h2 class="card-title fw-bold fs-4">Data Device</h2>
            <div class="card-tools">
                @can('admin.absensi_device.create')
                    <a class="btn btn-sm btn-primary" href="{{ route('admin.absensi_device.create') }}" data-toggle="modal" data-target="#modalLgId" data-modal-title="Tambah Data">
        ...
        {{-- <div class="card-header py-1">
			...
			{{-- <div class="form-row mb-0 d-flex justify-content-stretch">
                <div class="form-group mb-0 col-sm-2">
                    <label for="" class="form-label">Jenis Device</label>
