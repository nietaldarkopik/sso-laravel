...
<form action="{{ route('admin.absensi_device.store') }}" class="form-create-absensi_user" method="POST" enctype="multipart/form-data" data-id="{{ $absensi_device->id }}">
    @csrf
	@method("patch")
					...
					<div class="row">
						<div class="col-sm-6 p-0 px-1">
							<div class="form-group p-2 mb-1">
								...
								<input required="required" type="text" name="device_no" value="{{ $absensi_device->device_no }}"
						...
						<div class="col-sm-6 p-0 px-1">
							<div class="form-group p-2 mb-1">
								...
								<input required="required" type="text" name="device_name" value="{{ $absensi_device->device_name }}"
								class="form-control border py-0 text-italic-0"
						...
						<div class="col-sm-6 p-0 px-1">
							<div class="form-group p-2 mb-1">
								<label>Sn</label>
								<input required="required" type="text" name="sn" value="{{ $absensi_device->sn }}"
								class="form-control border py-0 text-italic-0"
								placeholder="Sn" />
							</div>
						</div>
						...
						<div class="col-sm-6 p-0 px-1">
							<div class="form-group p-2 mb-1">
								...
								<input required="required" type="text" name="ip_public" value="{{ $absensi_device->ip_public }}"
								class="form-control border py-0 text-italic-0"
						...
						<div class="col-sm-6 p-0 px-1">
							<div class="form-group p-2 mb-1">
								...
								<input required="required" type="text" name="ip_local" value="{{ $absensi_device->ip_local }}"
								class="form-control border py-0 text-italic-0"
						...
						<div class="col-sm-6 p-0 px-1">
							<div class="form-group p-2 mb-1">
								...
								<input required="required" type="number" name="port_public" value="{{ $absensi_device->port_public }}"
								class="form-control border py-0 text-italic-0"
						...
						<div class="col-sm-6 p-0 px-1">
							<div class="form-group p-2 mb-1">
								...
								<input required="required" type="number" name="port_local" value="{{ $absensi_device->port_local }}"
								class="form-control border py-0 text-italic-0"
						...
						<div class="col-sm-6 p-0 px-1">
							<div class="form-group p-2 mb-1">
								<label>Status</label>
								<select required="required" type="text" name="status"
								class="form-control border py-0 text-italic-0"
								placeholder="Status">
									<option value="">Pilih ...</option>
									<option value="Aktif" @selected($absensi_device->status == "Aktif")>Aktif</option>
									<option value="Tidak Aktif" @selected($absensi_device->status == "Tidak Aktif")>Tidak Aktif</option>
								</select>
							</div>
						</div>
						...
						<div class="col-sm-12 p-0 px-1">
							<div class="form-group p-2 mb-1">
								...
								<textarea required="required" type="text" name="location" value="{{ $absensi_device->location }}"
								class="form-control border py-0 text-italic-0" rows="4"
								placeholder="Location">{{ $absensi_device->location }} </textarea>
							</div>
						</div>
...
<script>
	...
	$(document).ready(function(){
		...
		$(".form-create-absensi_user").on("submit",function(e){
			...
			var id = $(this).data("id");
			var url = "{{ route('admin.absensi_device.update', 'xxx')}}";
