...
class AbsensiAttendenceModel extends Model
{
    ...
    protected $fillable = [
        "raw","id_device","id_device_datang","id_device_pulang","id_user","user_no","device_no","datang","pulang","tanggal","created_at","updated_at"
    ];
