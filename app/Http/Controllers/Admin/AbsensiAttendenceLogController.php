...
use App\DataTables\AbsensiAttendenceLogsDataTable;
...
class AbsensiAttendenceLogController extends Controller
{
    /**
    ...
    public function index(AbsensiAttendenceLogsDataTable $dataTable)
    {
        return $dataTable->render('vendor.adminlte.absensi-attendence-logs.index');
    }

    public function create(Request $request)
    {
        if($request->ajax()){
            return view('vendor.adminlte.absensi-attendence-logs.form-create', compact('kategoriPsus'));
        }else{
            return view('vendor.adminlte.absensi-attendence-logs.create', compact('kategoriPsus'));
        }
    }
    ...
    public function show($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.absensi-attendence-logs.form-show', compact('pengajuan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.absensi-attendence-logs.show', compact('pengajuan', 'kategoriPsus'));
        }
    }
    ...
    public function edit($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.absensi-attendence-logs.form-edit', compact('pengajuan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.absensi-attendence-logs.edit', compact('pengajuan', 'kategoriPsus'));
        }
    }
    ...
    public function pdf($id,Request $request)
    {
        ...
        $pdf = PDF::loadView('vendor.adminlte.absensi-attendence-logs.pdf', compact('pengajuan', 'kategoriPsus'))->setOptions(['defaultFont' => 'sans-serif']);

        return $pdf->download(Str::kebab($pengajuan->nama_percumahan).'.pdf');

        if($request->ajax()){
            return view('vendor.adminlte.absensi-attendence-logs.form-print', compact('pengajuan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.absensi-attendence-logs.print', compact('pengajuan', 'kategoriPsus'));
        }
    }
