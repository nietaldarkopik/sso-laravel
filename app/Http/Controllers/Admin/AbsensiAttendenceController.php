...
class AbsensiAttendenceController extends Controller
{
    /**
    ...
    public function index(AbsensiAttendencesDataTable $dataTable)
    {
        return $dataTable->render('vendor.adminlte.absensi-attendences.index');
    }

    public function create(Request $request)
    {
        if($request->ajax()){
            return view('vendor.adminlte.absensi-attendences.form-create');
        }else{
            return view('vendor.adminlte.absensi-attendences.create');
        }
    }
    ...
    public function show($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.absensi-attendences.form-show', compact('pengajuan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.absensi-attendences.show', compact('pengajuan', 'kategoriPsus'));
        }
    }
    ...
    public function edit($id,Request $request)
    {
        ...
        if($request->ajax()){
            return view('vendor.adminlte.absensi-attendences.form-edit', compact('pengajuan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.absensi-attendences.edit', compact('pengajuan', 'kategoriPsus'));
        }
    }
    ...
    public function pdf($id,Request $request)
    {
        ...
        $pdf = PDF::loadView('vendor.adminlte.absensi-attendences.pdf', compact('pengajuan', 'kategoriPsus'))->setOptions(['defaultFont' => 'sans-serif']);

        return $pdf->download(Str::kebab($pengajuan->nama_percumahan).'.pdf');

        if($request->ajax()){
            return view('vendor.adminlte.absensi-attendences.form-print', compact('pengajuan', 'kategoriPsus'));
        }else{
            return view('vendor.adminlte.absensi-attendences.print', compact('pengajuan', 'kategoriPsus'));
        }
    }
